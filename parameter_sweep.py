...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("Parameter Sweep: v_scale (drift scaling)")
    print("=" * 60)
    df_vscale = run_sweep("v_scale", [0.1, 0.5, 1.0, 2.0, 3.0])
    print(df_vscale.groupby("value")[
        ["overall_accuracy", "post_reversal_acc_1_5", "perseveration_rate", "mean_rt"]
    ].mean().round(3))
    fig_vscale = plot_sweep(df_vscale, "v_scale")
