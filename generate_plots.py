...
from rlddm import rlddm_simulate, rlddm_plot
...
# =============================================================================
print("1/5: Reversal-locked plots...")
...
# =============================================================================
print("\n2/5: Single-subject H1 diagnostic...")
fit_h1 = h1_subjects[0]
fig_h1_1, fig_h1_2 = rlddm_plot(fit_h1)
fig_h1_1.savefig("single_subject_h1_rl.png", dpi=150)
fig_h1_2.savefig("single_subject_h1_ddm.png", dpi=150)
print("   -> single_subject_h1_rl.png, single_subject_h1_ddm.png")

print("\n3/5: Single-subject H2 diagnostic...")
fit_h2 = h2_subjects[0]
fig_h2_1, fig_h2_2 = rlddm_plot(fit_h2)
fig_h2_1.savefig("single_subject_h2_rl.png", dpi=150)
fig_h2_2.savefig("single_subject_h2_ddm.png", dpi=150)
...
fig_bound.savefig("h2_boundary_over_trials.png", dpi=150)
...
fig_sweep.savefig("parameter_sweep_alpha.png", dpi=150)
...
# =============================================================================
print("\n5/5: Confusion matrix (this is slow)...")
