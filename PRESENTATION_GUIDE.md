...
- **Parameter recovery works for the key parameters:** a, a_base, κ, τ all recover well. If real data were generated by either mechanism, the fitting procedure could identify it.
